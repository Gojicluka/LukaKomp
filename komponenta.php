        ...
        foreach ($stmt->fetchAll() as $k => $row) {
            ...
            echo '
                        ...
                        <div style="margin-bottom:5px;">
                            <input type="button" style="background-color:red;" class="dugmence" value="-" id="kolicinaMinus" onclick="promeniKolicinu(-1)">
                            <input type="text" id="kolicinaTextBox" readonly value="1" style="width:20px;text-align:center;">
                            <input type="button" style="background-color:green;" class="dugmence"  id="kolicinaPlus" value="+" onclick="promeniKolicinu(1)">
                        </div>
                        ';
